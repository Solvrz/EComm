...
class InformationSheet extends StatefulWidget {
  ...
  InformationSheet(this.parentContext);
                    ...
                    child: addresses.length > 0
                        ? ListView.separated(
                            ...
                            separatorBuilder: (context, int index) =>
                                Divider(thickness: 0.75, color: Colors.grey[400]),
                          )
                        : Center(
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  "${widget.edit ? "Edit" : "New"} Information",
                  style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
                )
              ],
            ),
            ...
            GestureDetector(
              onTap: () async {
                if (await validateFields() == false)
                  ...
                  setState(() {}); //FIXME: DOESNT REFRESHES. NEEDS HOT RELOAD
